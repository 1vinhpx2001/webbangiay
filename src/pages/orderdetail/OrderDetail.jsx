...
export default function OrderDetail() {
    ...
    const [currentItemName, setCurrentcurrentItemName] = useState(null);
    const [currentItemImage, setCurrentcurrentItemImage] = useState(null);      
                                        ...
                                        <div className='mt-4 sm:mt-0 flex flex-col justify-between'>
                                            ...
                                            {order?.state === 'done' ?
                                                <>
                                                    ...
                                                    {isOpen && (
                                                        <RatingProduct orderItemId={currentOrderItemId} productName={currentItemName} productImg={currentItemImage}
                                                            isOpen={isOpenModal}
                                                        />
                                                    )}
                                                </>
