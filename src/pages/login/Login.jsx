                ...
                <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
                    <div className="w-full p-6 m-auto bg-white rounded-md shadow-md lg:max-w-xl">
                        ...
                        <form className="mt-6" >
                            ...
                            <div className="mt-6">
                                <Link to='https://sneaker-store-backend-production.up.railway.app/oauth2/authorization/google' className="w-full px-4 py-2 flex justify-center tracking-wide text-white transition-colors duration-200 transform bg-red-700 hover:bg-red-600 focus:outline-none focus:bg-red-600">
                                Sign in with Google
                                </Link>
                            </div>
                        </form>
